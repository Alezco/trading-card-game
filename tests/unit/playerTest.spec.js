import { isDeckEmpty, isDrawable, isHandFull } from '../../src/utils/player';
    ...
    describe("isHandFull", () => {
        it("should return true when hand is full", () => {
            const player = {
                ...
                health: 30,
                mana: 0,
                hand: [{id: 'Hassan', mana: 1}, {id: 'Benjamin', mana: 0}, {id: 'Marianne', mana: 8}, {id: 'Julien', mana: 1}, {id: 'Benji', mana: 5}],
                deck: [],
              };
        ...
        it("should return false when hand is not full", () => {
            const player = {
                ...
                health: 30,
                mana: 0,
                hand: [{id: 'Hassan', mana: 1}, {id: 'Benjamin', mana: 0}],
                deck: [{id: 'Jest', mana: 8}],
              };
    ...
    describe("isDrawable", () => {
        it("should return true when hand is not full and deck is not empty", () => {
            const player = {
                ...
                health: 30,
                mana: 0,
                hand: [{id: 'Hassan', mana: 1}, {id: 'Benjamin', mana: 0}, {id: 'Benji', mana: 5}],
